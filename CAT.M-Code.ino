...
const unsigned char cat_thermo_hour [] PROGMEM = {
  // 'Cat thermo and clock', 54x59px
  
};
...
void SecondScreen(){
  /*
    display1.fillRect(0, 0, 31, 64, SSD1306_WHITE);
    display1.fillRect(96, 0, 31, 64, SSD1306_WHITE);
  */
  display1.drawBitmap(37, 2, cat_thermo_hour, 54, 59, SSD1306_WHITE);
  parseWeather(weather,23,MainNr,MainString,MainData);  
  parseWeather(weather,12,MainNr,MainString,MainData); // THE CHOOSENR IS BACKWARDS
  DisplayHours(0,0,MainData,MainString);
}
...
void DisplayHours(int x,int y, int arr[],String hour){


  int curr_hour=hour.substring(0,2).toInt();
  if(curr_hour>12)
    curr_hour=12;
  ...
  int xmove=6;
  // first column
  DisplayText(1,xoffset*0+14,yoffset*0+ymove,String(arr[curr_hour])+"C");
  DisplayText(1,xoffset*0+14,yoffset*1+ymove,String(arr[curr_hour+1])+"C");
  DisplayText(1,xoffset*0+14,yoffset*2+ymove,String(arr[curr_hour+2])+"C");
  DisplayText(1,xoffset*0+14,yoffset*3+ymove,String(arr[curr_hour+3])+"C");
  DisplayText(1,xoffset*0+14,yoffset*4+ymove,String(arr[curr_hour+4])+"C");
  DisplayText(1,xoffset*0+14,yoffset*5+ymove,String(arr[curr_hour+5])+"C");

  DisplayText(1,xoffset*0,yoffset*0+ymove,String(curr_hour));
  DisplayText(1,xoffset*0,yoffset*1+ymove,String(curr_hour+1));
  DisplayText(1,xoffset*0,yoffset*2+ymove,String(curr_hour+2));
  DisplayText(1,xoffset*0,yoffset*3+ymove,String(curr_hour+3));
  DisplayText(1,xoffset*0,yoffset*4+ymove,String(curr_hour+4));
  DisplayText(1,xoffset*0,yoffset*5+ymove,String(curr_hour+5));
  /*
...
*/
  DisplayText(1,xoffset*3+14-xmove,yoffset*0+ymove,String(arr[curr_hour+6])+"C");
  DisplayText(1,xoffset*3+14-xmove,yoffset*1+ymove,String(arr[curr_hour+7])+"C");
  DisplayText(1,xoffset*3+14-xmove,yoffset*2+ymove,String(arr[curr_hour+8])+"C");
  DisplayText(1,xoffset*3+14-xmove,yoffset*3+ymove,String(arr[curr_hour+9])+"C");
  DisplayText(1,xoffset*3+14-xmove,yoffset*4+ymove,String(arr[curr_hour+10])+"C");
  DisplayText(1,xoffset*3+14-xmove,yoffset*5+ymove,String(arr[curr_hour+11])+"C");

  DisplayText(1,xoffset*3-xmove,yoffset*0+ymove,String(curr_hour+6));
  DisplayText(1,xoffset*3-xmove,yoffset*1+ymove,String(curr_hour+7));
  DisplayText(1,xoffset*3-xmove,yoffset*2+ymove,String(curr_hour+8));
  DisplayText(1,xoffset*3-xmove,yoffset*3+ymove,String(curr_hour+9));
  DisplayText(1,xoffset*3-xmove,yoffset*4+ymove,String(curr_hour+10));
  DisplayText(1,xoffset*3-xmove,yoffset*5+ymove,String(curr_hour+11));
}
